...
//1 초	128 MB	113638	51325	37136	44.046%
//
//문제
...
public class No9012 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < numCase; i++) {
			sb.append(checkSt(br.readLine()) + "\n");
		}
		System.out.println(sb);
	}

	static String checkSt(String str) {
		...
		for (int i = 0; i < str.length(); i++) {
			if (str.charAt(i) == '(') {
				...
				if (stack.isEmpty()) return "NO";	//pop()호출 전에 비어있으면
				stack.pop();
			}
		}

		if (stack.isEmpty()) return "YES";
		return "NO";	//끝났는데 stack이 비어있지 않으면
	}
}
